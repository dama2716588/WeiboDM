...
//        UIViewController *presentedViewController = (UIViewController *)[self.window.rootViewController self];
...
- (void)navigateToMainStateView{
    ...
    _navVC = [[DMNavigationController alloc] initWithRootViewController:_mainVC];
